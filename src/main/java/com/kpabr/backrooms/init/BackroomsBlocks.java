...
public class BackroomsBlocks {
	...
	public static final Block TABLE = add("table", new Block(FabricBlockSettings.copyOf(Blocks.OAK_WOOD).materialColor(DyeColor.YELLOW)), ItemGroup.BUILDING_BLOCKS);
