...
public abstract class AlmondWaterFluid extends FlowableFluid {

    public Fluid getFlowing() {
        return BackroomsFluids.ALMOND_WATER_FLOWING;
    }

    public Fluid getStill() {
        return BackroomsFluids.ALMOND_WATER_STILL;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return BackroomsBlocks.ALMOND_WATER_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == BackroomsFluids.ALMOND_WATER_STILL || fluid == BackroomsFluids.ALMOND_WATER_FLOWING;
    }
