...
public class BiomeRegistryListNew {
    ...
    public static BiomeRegistryListNew from(Registry<Biome> biomeRegistry, BiomeListBuilderNew biomeList) {
        final BiomeRegistryListNew list = new BiomeRegistryListNew();
