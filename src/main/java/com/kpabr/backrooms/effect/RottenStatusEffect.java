...
public class RottenStatusEffect extends StatusEffect {
    ...
    public RottenStatusEffect() {
        ...
        this.addAttributeModifier(EntityAttributes.GENERIC_MAX_HEALTH, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", -6.0,
                EntityAttributeModifier.Operation.ADDITION);
        this.addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 2.0,
                EntityAttributeModifier.Operation.ADDITION);
    }
