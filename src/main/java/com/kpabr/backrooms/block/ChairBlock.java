...
public class ChairBlock extends HorizontalFacingBlock implements BlockEntityProvider {

    public static final BooleanProperty LIT = Properties.LIT;

    public ChairBlock(FabricBlockSettings fabricBlockSettings) {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if(type == BackroomsBlocks.CHAIR_BLOCK_ENTITY) {
