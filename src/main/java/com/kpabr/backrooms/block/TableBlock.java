...
public class TableBlock extends HorizontalFacingBlock implements BlockEntityProvider {

    public static final BooleanProperty LIT = Properties.LIT;

    public TableBlock(FabricBlockSettings fabricBlockSettings) {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if(type == BackroomsBlocks.TABLE_BLOCK_ENTITY) {
